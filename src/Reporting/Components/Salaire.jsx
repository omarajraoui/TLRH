...
const Salaire = () => {
  console.log(useLocation().state.matricule);
  const id  = useLocation().state.matricule['matricule'];
  console.log(id)
  ...
  return (
    <div className="bg-stone-50 rounded-lg border border-gray-200 shadow-md">
